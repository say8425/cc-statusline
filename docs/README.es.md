...
- **Vista de barra lateral**: alterna entre árbol de carpetas y lista plana (el interruptor **Flatten** enumera cada archivo modificado por ruta completa, sin carpetas, con un cuadro de filtro — útil porque el colapso de carpetas del árbol casi nunca tiene nada que colapsar); el árbol también tiene alternancia de posición izquierda/derecha
